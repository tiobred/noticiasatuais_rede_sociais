...
export function Sidebar() {
    ...
    return (
        <>
            ...
            <aside
                className={`fixed left-0 top-0 h-full w-60 glass border-r border-white/5 flex flex-col z-50 transform transition-transform duration-300 md:translate-x-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}
            >
                {/* Logo */}
