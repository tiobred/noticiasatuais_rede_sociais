        ...
        <div className="flex h-screen bg-[#06060a] text-zinc-100 font-sans">
            ...
            <div className="ml-60 flex-1 flex flex-col overflow-hidden">
                <header className="flex justify-between items-center p-6 border-b border-zinc-800 bg-[#0a0a0f]">
                    <div>
                        <h1 className="text-2xl font-semibold text-white">Histórico de Posts</h1>
                        <p className="text-sm text-zinc-400 mt-1">Acervo de notícias processadas e enviadas.</p>
                    </div>
                </header>
                        ...
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="border-b border-zinc-800 bg-[#161622] text-zinc-400 text-sm">
                                    ...
                                    <th className="p-4 font-medium">Fonte</th>
